...
int LoadAircraft()
{
	IAnimatedMesh * pMesh = smgr->getMesh( "../module/1234.obj" );
...
void shoot()
{
	...
	ISceneNode* pMissileNode = smgr->addAnimatedMeshSceneNode( smgr->getMesh("../module/mayabottle.obj") );
...
scene::IParticleSystemSceneNode* CreateBullet()
{
	...
	m_bullet->setMaterialTexture(0, driver->getTexture("../media/fireball.bmp"));
