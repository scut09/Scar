...
struct UIStaticText_wrapper : UIStaticText, bp::wrapper< UIStaticText > {

    UIStaticText_wrapper(UIStaticText const & arg )
    : UIStaticText( arg )
...
BOOST_PYTHON_MODULE( UI )
{
    ...
    bp::class_< UIButton_wrapper, bp::bases< IUIObject > >( "UIButton", bp::init< IUIObject *, irr::s32, irr::s32, bp::optional< irr::s32, int, irr::core::vector2d< float > const &, irr::f32, irr::core::vector2d< float > const & > >(( bp::arg("parent"), bp::arg("width"), bp::arg("height"), bp::arg("order")=(::irr::s32)(0), bp::arg("shape")=int(::SQUARE), bp::arg("position")=irr::core::vector2d<float>(0.0f, 0.0f), bp::arg("rotdeg")=0, bp::arg("scale")=irr::core::vector2d<float>(1.0e+0f, 1.0e+0f) )) )    
        ...
        .def( 
            "AddFunc"
            , (void ( ::IUIObject::* )( ::std::string const &,::std::string const &,::std::string const & ) )(&::IUIObject::AddFunc)
            , (void ( UIButton_wrapper::* )( ::std::string const &,::std::string const &,::std::string const & ) )(&UIButton_wrapper::default_AddFunc)
            , ( bp::arg("eventName"), bp::arg("funcName"), bp::arg("ModuleName") ) )    
        .def( 
            "DrawTree"
            , (void ( ::IUIObject::* )(  ) )(&::IUIObject::DrawTree)
        ...
        .def( 
            "GetParent"
            , (::IUIObject * ( ::IUIObject::* )(  ) const)(&::IUIObject::GetParent)
            , (::IUIObject * ( UIButton_wrapper::* )(  ) const)(&UIButton_wrapper::default_GetParent)
                , bp::return_value_policy< bp::reference_existing_object >() )    
        .def( 
            "GetPosition"
            , (::irr::core::vector2d< float > const & ( ::IUIObject::* )(  ) const)(&::IUIObject::GetPosition)
        ...
        .def( 
            "PythonFunc"
            , (void ( ::IUIObject::* )( ::std::string const & ) )(&::IUIObject::PythonFunc)
            , (void ( UIButton_wrapper::* )( ::std::string const & ) )(&UIButton_wrapper::default_PythonFunc)
            , ( bp::arg("eventName") ) )    
        .def( 
            "RemoveAll"
            , (void ( ::IUIObject::* )(  ) )(&::IUIObject::RemoveAll)
        ...
        .def( 
            "RemoveFunc"
            , (void ( ::IUIObject::* )( ::std::string const & ) )(&::IUIObject::RemoveFunc)
            , (void ( UIButton_wrapper::* )( ::std::string const & ) )(&UIButton_wrapper::default_RemoveFunc)
            , ( bp::arg("funcName") ) )    
        .def( 
            "SetAlpha"
            , (void ( ::IUIObject::* )( ::irr::f32 ) )(&::IUIObject::SetAlpha)
    ...
    bp::class_< UIImage_wrapper, bp::bases< IUIObject > >( "UIImage", bp::init< IUIObject *, irr::s32, irr::s32, bp::optional< irr::s32, int, irr::core::vector2d< float > const &, irr::f32, irr::core::vector2d< float > const & > >(( bp::arg("parent"), bp::arg("width"), bp::arg("height"), bp::arg("order")=(::irr::s32)(0), bp::arg("shape")=int(::SQUARE), bp::arg("position")=irr::core::vector2d<float>(0.0f, 0.0f), bp::arg("rotdeg")=0, bp::arg("scale")=irr::core::vector2d<float>(1.0e+0f, 1.0e+0f) )) )    
        ...
        .def( 
            "AddFunc"
            , (void ( ::IUIObject::* )( ::std::string const &,::std::string const &,::std::string const & ) )(&::IUIObject::AddFunc)
            , (void ( UIImage_wrapper::* )( ::std::string const &,::std::string const &,::std::string const & ) )(&UIImage_wrapper::default_AddFunc)
            , ( bp::arg("eventName"), bp::arg("funcName"), bp::arg("ModuleName") ) )    
        .def( 
            "DrawTree"
            , (void ( ::IUIObject::* )(  ) )(&::IUIObject::DrawTree)
        ...
        .def( 
            "GetParent"
            , (::IUIObject * ( ::IUIObject::* )(  ) const)(&::IUIObject::GetParent)
            , (::IUIObject * ( UIImage_wrapper::* )(  ) const)(&UIImage_wrapper::default_GetParent)
                , bp::return_value_policy< bp::reference_existing_object >() )    
        .def( 
            "GetPosition"
            , (::irr::core::vector2d< float > const & ( ::IUIObject::* )(  ) const)(&::IUIObject::GetPosition)
        ...
        .def( 
            "PythonFunc"
            , (void ( ::IUIObject::* )( ::std::string const & ) )(&::IUIObject::PythonFunc)
            , (void ( UIImage_wrapper::* )( ::std::string const & ) )(&UIImage_wrapper::default_PythonFunc)
            , ( bp::arg("eventName") ) )    
        .def( 
            "RemoveAll"
            , (void ( ::IUIObject::* )(  ) )(&::IUIObject::RemoveAll)
        ...
        .def( 
            "RemoveFunc"
            , (void ( ::IUIObject::* )( ::std::string const & ) )(&::IUIObject::RemoveFunc)
            , (void ( UIImage_wrapper::* )( ::std::string const & ) )(&UIImage_wrapper::default_RemoveFunc)
            , ( bp::arg("funcName") ) )    
        .def( 
            "SetAlpha"
            , (void ( ::IUIObject::* )( ::irr::f32 ) )(&::IUIObject::SetAlpha)
    ...
    bp::class_< UIStaticText_wrapper, bp::bases< IUIObject > >( "UIStaticText", bp::init< IUIObject *, irr::s32, irr::s32, irr::core::stringw, irr::video::SColor, bp::optional< irr::u32, bool, bool, irr::s32, int, irr::core::vector2d< float > const &, irr::f32, irr::core::vector2d< float > const &, bool > >(( bp::arg("parent"), bp::arg("width"), bp::arg("hegit"), bp::arg("text"), bp::arg("color"), bp::arg("fontsize")=(::irr::u32)(14), bp::arg("hcenter")=(bool)(false), bp::arg("vcenter")=(bool)(false), bp::arg("order")=(::irr::s32)(0), bp::arg("shape")=int(::SQUARE), bp::arg("position")=irr::core::vector2d<float>(0.0f, 0.0f), bp::arg("rotdeg")=0, bp::arg("scale")=irr::core::vector2d<float>(1.0e+0f, 1.0e+0f), bp::arg("Isvisible")=(bool)(true) )) )    
        .def( 
            ...
            , (void ( UIStaticText_wrapper::* )(  ) )(&UIStaticText_wrapper::default_Draw) )    
        .def( 
            "AddAnimator"
            , (void ( ::IUIObject::* )( ::IUIAnimator * ) )(&::IUIObject::AddAnimator)
            , (void ( UIStaticText_wrapper::* )( ::IUIAnimator * ) )(&UIStaticText_wrapper::default_AddAnimator)
            , ( bp::arg("ani") ) )    
        .def( 
            "AddChild"
            , (void ( ::IUIObject::* )( ::IUIObject * ) )(&::IUIObject::AddChild)
            , (void ( UIStaticText_wrapper::* )( ::IUIObject * ) )(&UIStaticText_wrapper::default_AddChild)
            , ( bp::arg("child") ) )    
        .def( 
            "AddFunc"
            , (void ( ::IUIObject::* )( ::std::string const &,::std::string const &,::std::string const & ) )(&::IUIObject::AddFunc)
            , (void ( UIStaticText_wrapper::* )( ::std::string const &,::std::string const &,::std::string const & ) )(&UIStaticText_wrapper::default_AddFunc)
            , ( bp::arg("eventName"), bp::arg("funcName"), bp::arg("ModuleName") ) )    
        .def( 
            "DrawTree"
            , (void ( ::IUIObject::* )(  ) )(&::IUIObject::DrawTree)
            , (void ( UIStaticText_wrapper::* )(  ) )(&UIStaticText_wrapper::default_DrawTree) )    
        .def( 
            "GetAbsoluteAlpha"
            , (::irr::f32 ( ::IUIObject::* )(  ) const)(&::IUIObject::GetAbsoluteAlpha)
            , (::irr::f32 ( UIStaticText_wrapper::* )(  ) const)(&UIStaticText_wrapper::default_GetAbsoluteAlpha) )    
        .def( 
            "GetAbsolutePosition"
            , (::irr::core::vector2d< float > ( ::IUIObject::* )(  ) const)(&::IUIObject::GetAbsolutePosition)
            , (::irr::core::vector2d< float > ( UIStaticText_wrapper::* )(  ) const)(&UIStaticText_wrapper::default_GetAbsolutePosition) )    
        .def( 
            "GetAlpha"
            , (::irr::f32 ( ::IUIObject::* )(  ) const)(&::IUIObject::GetAlpha)
            , (::irr::f32 ( UIStaticText_wrapper::* )(  ) const)(&UIStaticText_wrapper::default_GetAlpha) )    
        .def( 
            "GetAnimators"
            , (::std::vector< IUIAnimator* > const & ( ::IUIObject::* )(  ) const)(&::IUIObject::GetAnimators)
            , bp::return_value_policy< bp::copy_const_reference >() )    
        ...
        .def( 
            "GetOrder"
            , (::irr::s32 ( ::IUIObject::* )(  ) const)(&::IUIObject::GetOrder)
            , (::irr::s32 ( UIStaticText_wrapper::* )(  ) const)(&UIStaticText_wrapper::default_GetOrder) )    
        .def( 
            "GetParent"
            , (::IUIObject * ( ::IUIObject::* )(  ) const)(&::IUIObject::GetParent)
            , (::IUIObject * ( UIStaticText_wrapper::* )(  ) const)(&UIStaticText_wrapper::default_GetParent)
                , bp::return_value_policy< bp::reference_existing_object >() )    
        .def( 
            "GetPosition"
            , (::irr::core::vector2d< float > const & ( ::IUIObject::* )(  ) const)(&::IUIObject::GetPosition)
		...
		.def( 
            "GetRotation"
            , (::irr::f32 ( ::IUIObject::* )(  ) const)(&::IUIObject::GetRotation)
            , (::irr::f32 ( UIStaticText_wrapper::* )(  ) const)(&UIStaticText_wrapper::default_GetRotation) )    
        .def( 
            "GetScale"
            , (::irr::core::vector2d< float > const & ( ::IUIObject::* )(  ) const)(&::IUIObject::GetScale)
            , bp::return_value_policy< bp::copy_const_reference >() )    
        .def( 
            "GetVisible"
            , (bool ( ::IUIObject::* )(  ) )(&::IUIObject::GetVisible)
            , (bool ( UIStaticText_wrapper::* )(  ) )(&UIStaticText_wrapper::default_GetVisible) )    
        .def( 
            "HitTest"
            , (::IUIObject * ( ::IUIObject::* )( ::irr::s32,::irr::s32 ) )(&::IUIObject::HitTest)
            , (::IUIObject * ( UIStaticText_wrapper::* )( ::irr::s32,::irr::s32 ) )(&UIStaticText_wrapper::default_HitTest)
            , ( bp::arg("x"), bp::arg("y") )
                , bp::return_value_policy< bp::reference_existing_object >() )    
        .def( 
            "IsPointIn"
            , (bool ( ::IUIObject::* )( ::irr::s32,::irr::s32 ) )(&::IUIObject::IsPointIn)
            , (bool ( UIStaticText_wrapper::* )( ::irr::s32,::irr::s32 ) )(&UIStaticText_wrapper::default_IsPointIn)
            , ( bp::arg("x"), bp::arg("y") ) )    
        .def( 
            "IsPointInCircle"
            , (bool ( UIStaticText_wrapper::* )( ::irr::s32,::irr::s32 ) )(&UIStaticText_wrapper::IsPointInCircle)
            , ( bp::arg("x"), bp::arg("y") ) )    
        .def( 
            "IsPointInSquare"
            , (bool ( UIStaticText_wrapper::* )( ::irr::s32,::irr::s32 ) )(&UIStaticText_wrapper::IsPointInSquare)
            , ( bp::arg("x"), bp::arg("y") ) )    
        .def( 
            "OnAnimate"
            , (void ( ::IUIObject::* )( ::irr::u32 ) )(&::IUIObject::OnAnimate)
            , (void ( UIStaticText_wrapper::* )( ::irr::u32 ) )(&UIStaticText_wrapper::default_OnAnimate)
            , ( bp::arg("time") ) )    
        .def( 
            "OnEvent"
            , (void ( ::IUIObject::* )( ::irr::SEvent const & ) )(&::IUIObject::OnEvent)
            , (void ( UIStaticText_wrapper::* )( ::irr::SEvent const & ) )(&UIStaticText_wrapper::default_OnEvent)
            , ( bp::arg("event") ) )    
        .def( 
            "OnKeyDown"
            , (void ( ::IUIObject::* )( ::irr::SEvent::SKeyInput const & ) )(&::IUIObject::OnKeyDown)
            , (void ( UIStaticText_wrapper::* )( ::irr::SEvent::SKeyInput const & ) )(&UIStaticText_wrapper::default_OnKeyDown)
            , ( bp::arg("event") ) )    
        .def( 
            "OnKeyUp"
            , (void ( ::IUIObject::* )( ::irr::SEvent::SKeyInput const & ) )(&::IUIObject::OnKeyUp)
            , (void ( UIStaticText_wrapper::* )( ::irr::SEvent::SKeyInput const & ) )(&UIStaticText_wrapper::default_OnKeyUp)
            , ( bp::arg("event") ) )    
        .def( 
            "OnMouseLeftButtonDown"
            , (void ( ::IUIObject::* )( ::irr::SEvent::SMouseInput const & ) )(&::IUIObject::OnMouseLeftButtonDown)
            , (void ( UIStaticText_wrapper::* )( ::irr::SEvent::SMouseInput const & ) )(&UIStaticText_wrapper::default_OnMouseLeftButtonDown)
            , ( bp::arg("event") ) )    
        .def( 
            "OnMouseLeftButtonUp"
            , (void ( ::IUIObject::* )( ::irr::SEvent::SMouseInput const & ) )(&::IUIObject::OnMouseLeftButtonUp)
            , (void ( UIStaticText_wrapper::* )( ::irr::SEvent::SMouseInput const & ) )(&UIStaticText_wrapper::default_OnMouseLeftButtonUp)
            , ( bp::arg("event") ) )    
        .def( 
            "OnMouseMove"
            , (void ( ::IUIObject::* )( ::irr::SEvent::SMouseInput const & ) )(&::IUIObject::OnMouseMove)
            , (void ( UIStaticText_wrapper::* )( ::irr::SEvent::SMouseInput const & ) )(&UIStaticText_wrapper::default_OnMouseMove)
            , ( bp::arg("event") ) )    
        .def( 
            "OnMouseRightButtonDown"
            , (void ( ::IUIObject::* )( ::irr::SEvent::SMouseInput const & ) )(&::IUIObject::OnMouseRightButtonDown)
            , (void ( UIStaticText_wrapper::* )( ::irr::SEvent::SMouseInput const & ) )(&UIStaticText_wrapper::default_OnMouseRightButtonDown)
            , ( bp::arg("event") ) )    
        .def( 
            "OnMouseRightButtonUp"
            , (void ( ::IUIObject::* )( ::irr::SEvent::SMouseInput const & ) )(&::IUIObject::OnMouseRightButtonUp)
            , (void ( UIStaticText_wrapper::* )( ::irr::SEvent::SMouseInput const & ) )(&UIStaticText_wrapper::default_OnMouseRightButtonUp)
            , ( bp::arg("event") ) )    
        .def( 
            "OnWheel"
            , (void ( ::IUIObject::* )( ::irr::SEvent::SMouseInput const & ) )(&::IUIObject::OnWheel)
            , (void ( UIStaticText_wrapper::* )( ::irr::SEvent::SMouseInput const & ) )(&UIStaticText_wrapper::default_OnWheel)
            , ( bp::arg("event") ) )    
        .def( 
            "PythonFunc"
            , (void ( ::IUIObject::* )( ::std::string const & ) )(&::IUIObject::PythonFunc)
            , (void ( UIStaticText_wrapper::* )( ::std::string const & ) )(&UIStaticText_wrapper::default_PythonFunc)
            , ( bp::arg("eventName") ) )    
        .def( 
            "RemoveAll"
            , (void ( ::IUIObject::* )(  ) )(&::IUIObject::RemoveAll)
            , (void ( UIStaticText_wrapper::* )(  ) )(&UIStaticText_wrapper::default_RemoveAll) )    
        .def( 
            "RemoveAnimator"
            , (void ( ::IUIObject::* )( ::IUIAnimator * ) )(&::IUIObject::RemoveAnimator)
            , (void ( UIStaticText_wrapper::* )( ::IUIAnimator * ) )(&UIStaticText_wrapper::default_RemoveAnimator)
            , ( bp::arg("ani") ) )    
        .def( 
            "RemoveAnimators"
            , (void ( ::IUIObject::* )(  ) )(&::IUIObject::RemoveAnimators)
            , (void ( UIStaticText_wrapper::* )(  ) )(&UIStaticText_wrapper::default_RemoveAnimators) )    
        .def( 
            "RemoveChild"
            , (void ( ::IUIObject::* )( ::IUIObject * ) )(&::IUIObject::RemoveChild)
            , (void ( UIStaticText_wrapper::* )( ::IUIObject * ) )(&UIStaticText_wrapper::default_RemoveChild)
            , ( bp::arg("node") ) )    
        .def( 
            "RemoveFunc"
            , (void ( ::IUIObject::* )( ::std::string const & ) )(&::IUIObject::RemoveFunc)
            , (void ( UIStaticText_wrapper::* )( ::std::string const & ) )(&UIStaticText_wrapper::default_RemoveFunc)
            , ( bp::arg("funcName") ) )    
        .def( 
            "SetAlpha"
            , (void ( ::IUIObject::* )( ::irr::f32 ) )(&::IUIObject::SetAlpha)
            , (void ( UIStaticText_wrapper::* )( ::irr::f32 ) )(&UIStaticText_wrapper::default_SetAlpha)
            , ( bp::arg("alpha") ) )    
        .def( 
            "SetOrder"
            , (void ( ::IUIObject::* )( ::irr::s32 ) )(&::IUIObject::SetOrder)
            , (void ( UIStaticText_wrapper::* )( ::irr::s32 ) )(&UIStaticText_wrapper::default_SetOrder)
            , ( bp::arg("order") ) )    
        .def( 
            "SetParent"
            , (void ( ::IUIObject::* )( ::IUIObject * ) )(&::IUIObject::SetParent)
            , (void ( UIStaticText_wrapper::* )( ::IUIObject * ) )(&UIStaticText_wrapper::default_SetParent)
            , ( bp::arg("parent") ) )    
        .def( 
            "SetPosition"
            , (void ( ::IUIObject::* )( ::irr::core::vector2d< float > const & ) )(&::IUIObject::SetPosition)
            , (void ( UIStaticText_wrapper::* )( ::irr::core::vector2d< float > const & ) )(&UIStaticText_wrapper::default_SetPosition)
            , ( bp::arg("pos") ) )    
        .def( 
            "SetRotation"
            , (void ( ::IUIObject::* )( ::irr::f32 ) )(&::IUIObject::SetRotation)
            , (void ( UIStaticText_wrapper::* )( ::irr::f32 ) )(&UIStaticText_wrapper::default_SetRotation)
            , ( bp::arg("rotdeg") ) )    
        .def( 
            "SetScale"
            , (void ( ::IUIObject::* )( ::irr::core::vector2d< float > const & ) )(&::IUIObject::SetScale)
            , (void ( UIStaticText_wrapper::* )( ::irr::core::vector2d< float > const & ) )(&UIStaticText_wrapper::default_SetScale)
            , ( bp::arg("scale") ) )    
        .def( 
            "SetVisible"
            , (void ( ::IUIObject::* )( bool ) )(&::IUIObject::SetVisible)
            , (void ( UIStaticText_wrapper::* )( bool ) )(&UIStaticText_wrapper::default_SetVisible)
            , ( bp::arg("isvisible") ) )    
        .def( 
            "UpdateAbsolutePosition"
            , (void ( ::IUIObject::* )(  ) )(&::IUIObject::UpdateAbsolutePosition)
            , (void ( UIStaticText_wrapper::* )(  ) )(&UIStaticText_wrapper::default_UpdateAbsolutePosition) )    
        .def( 
            "remove"
            , (void ( ::IUIObject::* )(  ) )(&::IUIObject::remove)
            , (void ( UIStaticText_wrapper::* )(  ) )(&UIStaticText_wrapper::default_remove) );
    ...
    bp::class_< IGUIStaticText_wrapper, boost::noncopyable >( "IGUIStaticText", bp::init< irr::gui::IGUIEnvironment *, irr::gui::IGUIElement *, irr::s32, irr::core::rect< int > >(( bp::arg("environment"), bp::arg("parent"), bp::arg("id"), bp::arg("rectangle") )) )    
        .def( 
            "enableOverrideColor"
