	...
	: m_uiManager( uiManager ), PlayerShip( player_ship ), LockedShip( NULL )
{
	...
	//SpeedText = new UIStaticText( m_uiManager->GetRoot(), 100, 100, L"速度：", irr::video::SColor(255,255,255,255), 20 );
	//SpeedText->SetPosition( vector2df( 200, 200 ) );
	SpeedText = (UIStaticText*)m_uiManager->GetObjectByName( "speedText" );
	// 获取护盾槽
	Shield1 = m_uiManager->GetObjectByName( "shield1" );
	Shield2 = m_uiManager->GetObjectByName( "shield2" );
	ShieldText = (UIStaticText*)m_uiManager->GetObjectByName( "speedText" );
	// 获取护甲槽
	Armor1 = m_uiManager->GetObjectByName( "armor1" );
	Armor2 = m_uiManager->GetObjectByName( "armor2" );
	ArmorText = (UIStaticText*)m_uiManager->GetObjectByName( "armorText" );
	// 获取水平仪
