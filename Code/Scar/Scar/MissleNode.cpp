...
void MissleNode::OnRegisterSceneNode()
{
	if (IsVisible)
	{
...
const core::aabbox3d<f32>& MissleNode::getBoundingBox() const
{
...
video::SMaterial& MissleNode::getMaterial(u32 i)
{
...
u32 MissleNode::getMaterialCount() const
{
...
//! Sets a new mesh
void MissleNode::setMesh(IMesh* mesh)
{
	if (!mesh)
...
void MissleNode::serializeAttributes(io::IAttributes* out, io::SAttributeReadWriteOptions* options) const
{
...
void MissleNode::deserializeAttributes(io::IAttributes* in, io::SAttributeReadWriteOptions* options)
{
...
void MissleNode::setReadOnlyMaterials(bool readonly)
{
	ReadOnlyMaterials = readonly;
}

//! Returns if the scene node should not copy the materials of the mesh but use them in a read only style
bool MissleNode::isReadOnlyMaterials() const
{
...
ISceneNode* MissleNode::clone(ISceneNode* newParent, ISceneManager* newManager)
{
...
MissleNode::MissleNode( irr::scene::IMesh* mesh, irr::scene::ISceneNode* parent,
	...
	: IWeapon( parent, mgr, id, position, rotation, scale )
{
	if ( !parent )
	{
...
ISceneNode* MissleNode::getTarget()
{
	return Target;
}
