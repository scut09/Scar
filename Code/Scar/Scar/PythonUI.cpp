...
struct IUIObject_wrapper : IUIObject, bp::wrapper< IUIObject > {
	...
	//virtual ::boost::numeric::ublas::matrix< float, boost::numeric::ublas::basic_row_major< unsigned long, long >, boost::numeric::ublas::unbounded_array< float, std::allocator< float > > > GetRelativeTransformation(  ) const  {
	...
	//    else{
	//        return this->IUIObject::GetRelativeTransformation(  );
	//    }
	//}
	//
	//::boost::numeric::ublas::matrix< float, boost::numeric::ublas::basic_row_major< unsigned long, long >, boost::numeric::ublas::unbounded_array< float, std::allocator< float > > > default_GetRelativeTransformation(  ) const  {
	//    return IUIObject::GetRelativeTransformation( );
	//}
...
BOOST_PYTHON_MODULE( UI ){
	...
	bp::class_< UIButton_wrapper, bp::bases< IUIObject > >( "UIButton", bp::init< IUIObject *, irr::s32, irr::s32, bp::optional< irr::s32, irr::core::vector2d< float > const &, irr::f32, irr::core::vector2d< float > const & > >(( bp::arg("parent"), bp::arg("width"), bp::arg("height"), bp::arg("order")=(::irr::s32)(0), bp::arg("position")=irr::core::vector2d<float>(0.0f, 0.0f), bp::arg("rotdeg")=0, bp::arg("scale")=irr::core::vector2d<float>(1.0e+0f, 1.0e+0f) )) )    
		...
		"GetRelativeTransformation"
		, (::boost::numeric::ublas::matrix< float, boost::numeric::ublas::basic_row_major< unsigned long, long >, boost::numeric::ublas::unbounded_array< float, std::allocator< float > > > ( ::IUIObject::* )(  ) const)(&::IUIObject::GetRelativeTransformation)
		, (::boost::numeric::ublas::matrix< float, boost::numeric::ublas::basic_row_major< unsigned long, long >, boost::numeric::ublas::unbounded_array< float, std::allocator< float > > > ( UIButton_wrapper::* )(  ) const)(&UIButton_wrapper::default_GetRelativeTransformation) )    */
		.def( 
		"GetRotation"
		, (::irr::f32 ( ::IUIObject::* )(  ) const)(&::IUIObject::GetRotation)
	...
	bp::class_< UIImage_wrapper, bp::bases< IUIObject > >( "UIImage", bp::init< IUIObject *, irr::s32, irr::s32, bp::optional< irr::s32, irr::core::vector2d< float > const &, irr::f32, irr::core::vector2d< float > const & > >(( bp::arg("parent"), bp::arg("width"), bp::arg("height"), bp::arg("order")=(::irr::s32)(0), bp::arg("position")=irr::core::vector2d<float>(0.0f, 0.0f), bp::arg("rotdeg")=0, bp::arg("scale")=irr::core::vector2d<float>(1.0e+0f, 1.0e+0f) )) )    
		...
		"GetRelativeTransformation"
		, (::boost::numeric::ublas::matrix< float, boost::numeric::ublas::basic_row_major< unsigned long, long >, boost::numeric::ublas::unbounded_array< float, std::allocator< float > > > ( ::IUIObject::* )(  ) const)(&::IUIObject::GetRelativeTransformation)
		, (::boost::numeric::ublas::matrix< float, boost::numeric::ublas::basic_row_major< unsigned long, long >, boost::numeric::ublas::unbounded_array< float, std::allocator< float > > > ( UIImage_wrapper::* )(  ) const)(&UIImage_wrapper::default_GetRelativeTransformation) )    */
		.def( 
		"GetRotation"
		, (::irr::f32 ( ::IUIObject::* )(  ) const)(&::IUIObject::GetRotation)
