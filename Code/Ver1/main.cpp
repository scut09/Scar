...
//	// ---------------------------------------------------------------------------------------------
//
//	//scene::IAnimatedMesh* mesh1 = smgr->getMesh("yourmeshpath");
//	//scene::ISceneNode* node1 = smgr->addOctreeSceneNode(mesh1->getMesh(0));
//
//	//scene::ITriangleSelector* sel1 = smgr->createOctreeTriangleSelector(mesh1->getMesh(0),node1);
...
//	//anim1->drop();
//
//	//scene::IAnimatedMesh* mesh2 = smgr->getMesh("yourmeshpath");
//	//scene::ISceneNode* node2 = smgr->addOctreeSceneNode(mesh1->getMesh(0));
//	//scene::ITriangleSelector* sel2 = smgr->createOctreeTriangleSelector(mesh2->getMesh(0), node2);
//	//node->setTriangleSelector(sel2);
